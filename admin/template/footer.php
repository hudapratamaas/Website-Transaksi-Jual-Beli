   <!--main content end-->
      ...
      <footer class="site-footer">
          <div class="text-center">
              <?php echo date('Y');?> - Sistem Penjualan Pulsa & Kouta Internet Berbasis Web | 
              By <a href="https://ump.ac.id/" style="color:yellow;font-weight:700;" target="_blank">UEMPE CELULLER</a>
              <a href="#" class="go-top">
